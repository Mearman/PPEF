...
describe("index.ts export verification", () => {
	test("src/aggregation/index.ts exports aggregators and pipeline", async () => {
		...
		assert.ok(typeof aggregationModule.computeComparison === "function", "should export computeComparison");
		assert.ok(typeof aggregationModule.computeMaxSpeedup === "function", "should export computeMaxSpeedup");
		assert.ok(typeof aggregationModule.computeRankings === "function", "should export computeRankings");
		assert.ok(typeof aggregationModule.computeSpeedup === "function", "should export computeSpeedup");
		assert.ok(typeof aggregationModule.computeSummaryStats === "function", "should export computeSummaryStats");
		assert.ok(typeof aggregationModule.aggregateResults === "function", "should export aggregateResults");
		assert.ok(typeof aggregationModule.createAggregationOutput === "function", "should export createAggregationOutput");
	});
	...
	test("src/claims/index.ts exports evaluator", async () => {
		...
		assert.ok(typeof claimsModule.createClaimSummary === "function", "should export createClaimSummary");
	});
	...
	test("src/collector/index.ts exports result-collector and schema", async () => {
		...
		assert.ok(typeof collectorModule.ResultCollector === "function", "should export ResultCollector");
		...
		assert.ok(typeof collectorModule.validateSutRegistration === "function", "should export validateSutRegistration");
	});
	...
	test("src/executor/index.ts exports executor types and functions", async () => {
		...
		assert.ok(typeof executorModule.CheckpointManager === "function", "should export CheckpointManager");
		assert.ok(typeof executorModule.createFileCheckpointManager === "function", "should export createFileCheckpointManager");
		assert.ok(typeof executorModule.getGitCommit === "function", "should export getGitCommit");
		assert.ok(typeof executorModule.createCheckpointStorage === "function", "should export createCheckpointStorage");
		...
		assert.ok(typeof executorModule.getGitNamespace === "function", "should export getGitNamespace");
		...
		assert.ok(typeof executorModule.executeParallel === "function", "should export executeParallel");
		assert.ok(typeof executorModule.shardPath === "function", "should export shardPath");
		assert.ok(typeof executorModule.generateConfigHash === "function", "should export generateConfigHash");
	...
	test("src/renderers/index.ts exports renderers and types", async () => {
		...
		assert.ok(typeof renderersModule.createLatexRenderer === "function", "should export createLatexRenderer");
	...
	test("src/robustness/index.ts exports analyzer and perturbations", async () => {
		...
		assert.ok(typeof robustnessModule.analyzeRobustnessForMetric === "function", "should export analyzeRobustnessForMetric");
		assert.ok(typeof robustnessModule.analyzeRobustnessWithCurve === "function", "should export analyzeRobustnessWithCurve");
		assert.ok(typeof robustnessModule.compareRobustness === "function", "should export compareRobustness");
		assert.ok(typeof robustnessModule.createRobustnessAnalysis === "function", "should export createRobustnessAnalysis");
		assert.ok(typeof robustnessModule.createPerturbation === "function", "should export createPerturbation");
		assert.ok(robustnessModule.edgeRemovalPerturbation, "should export edgeRemovalPerturbation");
		assert.ok(typeof robustnessModule.getPerturbation === "function", "should export getPerturbation");
	...
	test("src/statistical/index.ts exports mann-whitney-u", async () => {
		...
		assert.ok(typeof statisticalModule.mannWhitneyUTest === "function", "should export mannWhitneyUTest");
		...
		assert.ok(typeof statisticalModule.confidenceInterval === "function", "should export confidenceInterval");
	});
	...
	test("src/index.ts exports all modules (main entry point)", async () => {
		...
		assert.ok(typeof mainModule.CaseRegistry === "function", "should export CaseRegistry from registry");
		assert.ok(typeof mainModule.SUTRegistry === "function", "should export SUTRegistry from registry");
		assert.ok(typeof mainModule.Executor === "function", "should export Executor from executor");
		assert.ok(typeof mainModule.createExecutor === "function", "should export createExecutor from executor");
		assert.ok(typeof mainModule.ResultCollector === "function", "should export ResultCollector from collector");
		assert.ok(typeof mainModule.mannWhitneyUTest === "function", "should export mannWhitneyUTest from statistical");
		assert.ok(typeof mainModule.computeSpeedup === "function", "should export computeSpeedup from aggregation");
		assert.ok(typeof mainModule.evaluateClaim === "function", "should export evaluateClaim from claims");
		assert.ok(typeof mainModule.analyzeRobustnessForMetric === "function", "should export analyzeRobustnessForMetric from robustness");
		assert.ok(typeof mainModule.LaTeXRenderer === "function", "should export LaTeXRenderer from renderers");
	});
});
